...
namespace Frxs.Erp.WarehouseManagementSystem.WebUI.Models
{
    ...
    /// </summary>
    [Serializable]
    public partial class BuyOrderPreDetailsModel : BaseModel
    {
        /// <summary>
        /// 采购单编号
        /// </summary>
        ...
        [DisplayName("收货数量")]
        [Required(ErrorMessage = "{0}不能为空")]
        public string BuyQtystr { get; set; }
        ...
        [DisplayName("进价")]
        [Required(ErrorMessage = "{0}不能为空")]
        public string BuyPricestr { get; set; }
        ...
        [DisplayName("包装数")]
        [Required(ErrorMessage = "{0}不能为空")]
        public string BuyPackingQtystr { get; set; }
