...
function gridload() {
    $('#grid').datagrid({
        ...
        columns: [[
            ...
            { title: '返配数量', field: 'AppQty', width: 80, align: 'center', formatter: function (value) {
                    return parseFloat(value).toFixed(2);
                }
            },
            {
                title: '返配价格', field: 'NewPrice', width: 80, formatter: function (value) {
