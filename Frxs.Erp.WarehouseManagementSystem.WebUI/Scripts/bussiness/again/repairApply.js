...
function initGrid() {
    $('#grid').datagrid({
        ...
        onDblClickCell: function () {
            ...
            frxs.openNewTab("查看补货申请单" + selRow.AppID, "../Again/RepairApplyAddOrEdit?action=view&appId=" + selRow.AppID, "icon-search");
        },
        ...
        frozenColumns: [[
            ...
            { title: '补货单号', field: 'AppID', width: 140, align: 'center' }
            //冻结列
        ]],
        columns: [[
            ...
            //{ title: '仓库名称2', field: 'SubWName', width: 120 },
            ...
            { title: '备注', field: 'Remark', width: 220, formatter: frxs.formatText }
...
//添加
function add() {
    frxs.openNewTab("添加补货申请单", "../Again/RepairApplyAddOrEdit", "icon-add", window);
}
...
function look() {
    ...
    frxs.openNewTab("查看补货申请单" + selRow[0].AppID, "../Again/RepairApplyAddOrEdit?action=view&appId=" + selRow[0].AppID, "icon-search");
}
