$(function () {
    ...
    $("#aSubmit").click(function () {
        ...
        //easyUI表单校验
        var isValidate = $("form[action='WarehouseEmpHandle']").form("validate");

        if (isValidate) {
            //提交表单
            submitForm("WarehouseEmpHandle", null, null, false, callbackResponse);
        }
    ...
    //修改下拉菜单的宽度
    $("span.combo").width("180");
    $("span.combo").find(".textbox-text").width("110");
})
