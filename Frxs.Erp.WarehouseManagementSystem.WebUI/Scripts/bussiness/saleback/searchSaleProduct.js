    ...
    if (productCode) {
        ...
        if (isNaN(onebyte) && onebyte != "赠") {
            ...
            if(productCode.length>6) {
                $("#type").combobox("setValue", "BarCode");
            }
        }
    }
...
function loadgrid() {
    ...
    $('#grid').datagrid({
        ...
        methord: 'get',                    //提交方式
        url: '../Common/GetSaleProductInfoSaleAll?ShopID=' + shopID + "&subWId=" + subWId,          //Aajx地址
        ...
        columns: [[
            ...
            { title: '单位', field: 'SaleUnit', width: 80, align: 'center' },
            ...
            { title: '库存数', field: 'WStock', width: 100, align: 'center' },
            { title: '国际条码', field: 'BarCode', width: 140, align: 'center' },
            { title: 'ProductId', field: 'ProductId', hidden: true, width: 100 },
            { title: 'UnitPrice', field: 'UnitPrice', hidden: true, width: 100 },
            { title: '平台费率', field: 'ShopAddPerc', hidden: true, width: 80 },
