...
function loadgrid() {
    $('#shopGrid').datagrid({
        ...
        columns: [[
            ...
            { title: '门店名称', field: 'ShopName', width: 220, align: 'left', formatter: frxs.formatText },
            { title: '门店地址', field: 'Address', width: 280,formatter:frxs.formatText }
...
//grid高度改变
function gridresize() {
    var h = ($(window).height() - $("fieldset").height() - 15);
