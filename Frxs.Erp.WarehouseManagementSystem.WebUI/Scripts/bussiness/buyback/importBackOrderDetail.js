...
function gridload() {
    $('#grid').datagrid({
        ...
        columns: [[
            ...
            { title: '单位', field: 'BackUnit', align: 'center', width: 80 },
            { title: '数量', field: 'BackQty', width: 60, align: 'right', formatter: function (value) {
                return value ? parseFloat(value).toFixed(2) : value;
            }
             },
            { title: '包装', field: 'BackPackingQty', align: 'right', width: 60 },
            {
            ...
            {
                title: '退货价', field: 'BackPrice', align: 'right', width: 70, formatter: function (value) {
                    return value ? parseFloat(value).toFixed(4) : value;
                }
            },
